                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-secondary dark:bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link
                                to={"/classifications"}
                                className={route === "/classifications" ? activeLink : nonActiveLink}
                            >
                                <svg
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap text-white">Classifications</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                to={"/patients"}
                                className={route === "/patients" ? activeLink : nonActiveLink}
                            >
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap text-white">Patients</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                to={"/users"}
                                className={route === "/users" ? activeLink : nonActiveLink}
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white"
                                    aria-hidden="true"
                        ...
                        <li>
                            <button
                                ...
                                className={route === "/patients-form" ? activeLink : nonActiveLink}
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white"
                                    aria-hidden="true"
                                ...
                                <span className="flex ms-3 whitespace-nowrap text-white">Create Patients</span>
                            </button>
                        </li>
                        <li>
                            <button
                                ...
                                className={route === "/users-form" ? activeLink : nonActiveLink}
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white"
                                    aria-hidden="true"
                                ...
                                <span className="flex ms-3 whitespace-nowrap text-white">Create User</span>
                            </button>
                        </li>
                        <li>
                            <button
